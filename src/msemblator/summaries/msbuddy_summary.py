...
def process_buddy_summary(buddy_folder, machine_dir, name_adduct_df, summary_df, score_df, top_n = 5):
    ...
    buddy_score_pipeline_path = os.path.join(machine_dir, "pipeline_msbuddy_score.pkl")
    buddy_SD_pipeline_path = os.path.join(machine_dir, "pipeline_msbuddy_score_diff.pkl")
