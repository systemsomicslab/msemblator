...
import pandas as pd
import joblib
from msemblator.chemistry.convert_struc_data_type import normalize_rank_score as normalize_rank_n
...
def process_msfinder_output(msfinder_folder, machine_dir, name_adduct_df, 
    ...
    msfinder_score_pipeline_path = os.path.join(machine_dir, "pipeline_msfinder_score_diff.pkl")
    msfinder_SD_pipeline_path = os.path.join(machine_dir, "pipeline_msfinder_structure_score.pkl")
